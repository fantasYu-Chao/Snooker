...
import snooker2D.BasicKeyListener;
...
public class BasicEngineForSnooker {
	...
	public BasicEngineForSnooker() {
		...
		billiards.add(new Billiard(Color.PINK, brownPos, 0, 0, ballSize / 2, ballWeight, true, 4)); // brown ball
		billiards.add(new Billiard(Color.BLUE, bluePos, 0, 0, ballSize / 2, ballWeight, true, 5));
		billiards.add(new Billiard(Color.MAGENTA, pinkPos, 0, 0, ballSize / 2, ballWeight, true, 6)); // pink ball
